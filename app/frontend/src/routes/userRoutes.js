...
// const { getAllQuestionsbyAI } = require('../../../backend/controllers/aiController');
...
const { getUserAttemptById, checkUserAttempt, updateUserAttempt, getUserById, getUserProgress, getUsers, updateUserById, updateUserProgress, getUserAttempts, addUserAttempt } = require('../../../backend/controllers/userController');
